...
function filterByAwardxTeamxAge(noOfAwards, team, age){
  var data = players.filter(palyer => (player.age < age && player.team == team && player.awards.length >= noOfAwards));
  return data;
}
...
function SortByNamexAwardsxTimes(awardName, noOfTimes, country){
  ...
  var dataTwo = dataOne.filter(palyer => player.country == country);
